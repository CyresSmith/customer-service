...
import { useUpdatePasswordMutation, useUpdateUserMutation, useUploadAvatarMutation } from "services/auth.api";
...
const ProfileContent = () => {
    ...
    const handleUpload = async (currentFile: File) => {
        ...
        const { url } = await uploadAvatarMutation({ id: +user?.id, data }).unwrap();
