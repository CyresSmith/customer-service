...
const categoryInputs: InputProps[] = [{ name: 'name', type: 'text', value: '' }];

const AddCategoryModal = ({ modalId, type, isOpen, closeModal, onCategoryAdd }: Props) => {
    ...
    return (
        <Modal title="Додати нову категорію" $isOpen={isOpen} closeModal={closeModal} id={modalId}>
            <CustomForm
