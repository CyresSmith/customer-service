...
export const Picker = styled.input<Pick <DatePickerProps, '$isOpen'>>`
    ...
    border: ${theme.borders.normal} ${props => props.$isOpen ? theme.colors.accent.main : theme.colors.bg.dark};
...
export const DateBox = styled.div<DatePickerProps>`
    ...
    background-color: ${props => props.$bgColor === 'dark' ? theme.colors.bg.main : theme.colors.secondary.main};
