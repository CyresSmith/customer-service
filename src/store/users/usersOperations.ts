...
const verify = createAsyncThunk<User, string, { rejectValue: string }>(
  'users/verify',
...
const login = createAsyncThunk<User, State, { rejectValue: string }>(
  'users/login',
...
const current = createAsyncThunk<User, undefined, { rejectValue: string }>(
  'users/current',
...
const logout = createAsyncThunk<boolean, undefined, { rejectValue: string }>(
  'users/logout',
  async (_, { rejectWithValue }) => {
    try {
